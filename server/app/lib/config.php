...
define('INVAL_LOGIN', 'Wrong login - the login can consist only of letters of the English alphabet and numbers and must be at least 3 characters and not more than 30');
